  ...
  <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav navbar-nav-cus ml-auto">
                  <li class="nav-item ">
                    <a class="nav-link " href="homeBussiness">Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link "data-toggle="modal" data-target="#select-recipent-chat" >Messages</a>
                  </li>
                  
                  <li class="nav-item">
                    <a class="nav-link " href="manageStore">Manage</a>
                  </li>
                  <li class="nav-item d-flex align-items-center">
                  @include('Frontend.Navs.Header.manageReview')
                  </li>

                  <li class="nav-item">
                    @include('Frontend.Navs.Header.profileheader')
                  </li>
                </ul>
              </div>
          </div>
